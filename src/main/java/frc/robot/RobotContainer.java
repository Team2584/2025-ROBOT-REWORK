...
public class RobotContainer {
  ...
  private final Autons autonClass;
  ...
  public RobotContainer() {
    ...
    // This is just so we can pass through RobotContainer to Autons.
    autonClass = new Autons(this);
  ...
  public void resetToAutoPose() {
    ...
    try {
      desiredRotation = PathPlannerAuto.getPathGroupFromAutoFile(Autons.autoChooser.getSelected().getName()).get(0)
